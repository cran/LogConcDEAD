...
\usepackage{amsmath,amsthm,bbm,amssymb, amscd, ifthen, subfigure, psfrag}
...
%\VignetteDepends{LogConcDEAD, logcondens, akima, rgl, MASS}                                      
...
%% information NOTE: Typically, this can be left commented
%% and will be filled out by the technical editor \Volume{13}
%% \Issue{9} \Month{September} \Year{2004} \Submitdate{2004-09-29}
%% \Acceptdate{2004-09-29}

%% The address of (at least) one author should be given in the
%% following format:
\Address{
...
if(!require(logcondens)) {install.packages("logcondens"); library("logcondens")}
...
\SweaveInput{intro.intRnw}
\SweaveInput{algorithm.intRnw}
\SweaveInput{usage.intRnw}
\clearpage
